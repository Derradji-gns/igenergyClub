  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl text-center md:text-4xl mb-4 text-white text-bold max-w-4xl">
          Iconic Moments
        </h2>
        <p
          className="text-white text-center text-sm md:text-center max-w-sm">
          Igenergy has a great stories , and in each one there are iconic moments that never be forgotten
        </p>
      </div>
